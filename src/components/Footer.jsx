      ...
      <div className="max-w-[1120px] py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
          ...
          <p className="mt-2 text-sm text-gray-300">
            Explore Our Collection Of HandPicked, Feature Propterties <br />
            That Stand Out For Their Exceptional Features And Prime Locations.
          </p>
        </div>
        <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 font-light">
              <li>
                <a className=" hover:border-b hover:duration-300 duration-300 text-sm cursor-pointer text-gray-300">
                  Became An Agent
                </a>
              </li>
              <li>
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            <h2 className="title-font font-ligt text-white tracking-widest text-sm mb-3">
              Company
            </h2>
            <nav className="list-none mb-10 font-light">
              <li>
