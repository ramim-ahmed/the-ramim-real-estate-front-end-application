    ...
    <div className="bg-[#F6F6FE]">
      <div className="max-w-[1120px] mx-auto py-10">
        ...
        <div className="mt-3 grid grid-cols-12 gap-6 bg-white p-6 rounded-md">
          ...
          <div className="col-span-4 lg:border-l-2 px-4 space-y-3">
        ...
        <div className="grid grid-cols-12 mt-4 gap-6">
          <div className="col-span-9 bg-white p-6 rounded-md">
            <div>
          ...
          <div
            ...
            className="col-span-3 bg-center bg-no-repeat bg-cover rounded-md p-4 flex justify-center items-center"
          >
